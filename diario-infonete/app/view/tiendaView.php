...
if (isset($_SESSION["usuarioOK"])) {
    ...
    <div class="container text-center">
        <div class="row">
            ...
            <div class="col ">
                <?php
                if (isset($revistasTienda)) {
                    $tam = sizeof($revistasTienda);
                    for ($i = 1; $i <= $tam; $i++) {
                        $posi = explode("-", $revistasTienda[$i]);
                        ...
                        echo "<a href='index.php?page=buscarSecciones&Id_usuario=$pos[0]&Cod_revista=$posi[0]' class=\"w3-button bg-primary w3-margin-bottom text-white\">Suscribirse</a>";
                        echo "</div>";
                        echo "</div>";
